...
export default function WithdrawalsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-800 text-white p-4 sm:p-10">
      <h1 className="text-2xl sm:text-3xl font-bold mb-5">Withdrawals</h1>
        ...
        <>
          ...
          <div className="md:hidden space-y-4">
            {withdrawals.map((w) => (
              ...
              >
                <p>
                  <span className="font-semibold">User ID:</span> {w.userId}
                </p>
                <p>
            ...
            {withdrawals.length === 0 && (
              <p className="text-center text-slate-400">No withdrawals found</p>
            )}
          </div>
        </>
      )}
